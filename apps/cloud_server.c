...
/*
 ...
 title of input_file   : server_lite_16806
*/
...
static char g_openlevel_RESOURCE_INTERFACE[][MAX_STRING] = {"oic.if.a","oic.if.r","oic.if.baseline"}; /* interface if (as an array) */
int g_openlevel_nr_resource_interfaces = 3;
/**
...
app_init(void)
{
  ...
  ret |= oc_add_device("/oic/d", "oic.d.light", "server_lite_16806", 
                       "ocf.2.0.5", /* icv value */
...
initialize_variables(void)
{
  ...
  g_openlevel_openLevel = 50; /* current value of property "openLevel" How open or ajar the entity is. */
...
int init;
  ...
  PRINT("OCF Server name : \"server_lite_16806\"\n");
...
*/
  ...
  */
  ...
  PRINT("OCF server \"server_lite_16806\" running, waiting on incoming connections.\n");
